        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="loginform" method="POST" action="{{ Url('login') }}">
                        @csrf
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="email" aria-label="email" name="email" aria-describedby="basic-addon1" required="email">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">

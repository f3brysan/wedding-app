                    ...
                    <div class="card">
                        ...
                        <div class="comment-widgets scrollable">
                            ...
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><img src="{{ asset('/') }}backend/assets/images/users/4.jpg" alt="user"
                            ...
                            <!-- Comment Row -->
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><img src="{{ asset('/') }}backend/assets/images/users/5.jpg" alt="user"
                                        width="50" class="rounded-circle"></div>
                                <div class="comment-text w-100">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="chat-box scrollable" style="height:475px;">
                                ...
                                <ul class="chat-list">
                                    <!--chat Row -->
                                    <li class="chat-item">
                                        <div class="chat-img"><img src="{{ asset('/') }}backend/assets/images/users/1.jpg" alt="user">
                                        </div>
                                    ...
                                    <!--chat Row -->
                                    <li class="chat-item">
                                        <div class="chat-img"><img src="{{ asset('/') }}backend/assets/images/users/2.jpg" alt="user">
                                        </div>
                                        <div class="chat-content">
                                    ...
                                    <!--chat Row -->
                                    <li class="chat-item">
                                        <div class="chat-img"><img src="{{ asset('/') }}backend/assets/images/users/3.jpg" alt="user">
                                        </div>
                                        <div class="chat-content">
                    ...
                    <div class="card">
                        ...
                        <div class="comment-widgets scrollable" style="max-height: 130px;">
                            <!-- Comment Row -->
                            <div class="d-flex flex-row comment-row mt-0">
                                <div class="p-2"><img src="{{ asset('/') }}backend/assets/images/users/1.jpg" alt="user"
                                        width="50" class="rounded-circle"></div>
                                <div class="comment-text w-100">
                                    <h6 class="font-medium">James Anderson</h6>
                                    <span class="mb-3 d-block">Lorem Ipsum is simply dummy text of the printing
